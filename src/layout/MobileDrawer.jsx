...
export default function MobileDrawer({ open, onClose, s, go, user, patch, notify }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 80 }}>
      ...
      <div style={{ position: 'absolute', top: 0, right: 0, bottom: 0, width: 'min(320px, 85vw)', background: 'var(--white)', boxShadow: 'var(--shadow-4)', display: 'flex', flexDirection: 'column', animation: 'modalIn 180ms var(--ease-out)' }}>
