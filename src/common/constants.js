...
export const ADMIN_NAV = [['dash', 'Tổng quan'], ['aplates', 'Biển số'], ['acats', 'Danh mục'], ['acontacts', 'Yêu cầu liên hệ'], ['aposts', 'Bài viết'], ['ameanings', 'Ý nghĩa phong thủy'], ['astaff', 'Nhân viên'], ['acustomers', 'Khách hàng'], ['avideos', 'Video'], ['anotifications', 'Thông báo'], ['areviews', 'Đánh giá'], ['acollabs', 'Cộng tác viên']];
...
export const STATUS_FG = { 'Mới': 'var(--blue-700)', 'Đang tư vấn': '#8A6100', 'Đã chốt': '#1B7A5A' };
