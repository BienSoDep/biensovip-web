...
export const ADMIN_NAV = [['dash', 'Tổng quan'], ['aplates', 'Biển số'], ['acats', 'Danh mục'], ['acontacts', 'Yêu cầu liên hệ'], ['aposts', 'Bài viết'], ['astaff', 'Nhân viên'], ['acustomers', 'Khách hàng'], ['avideos', 'Video'], ['anotifications', 'Thông báo'], ['acollabs', 'Cộng tác viên']];
