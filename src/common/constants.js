...
export const ADMIN_NAV = [['dash', 'Tổng quan'], ['aguide', 'Hướng dẫn sử dụng'], ['aplates', 'Biển số'], ['acats', 'Danh mục'], ['acontacts', 'Yêu cầu liên hệ'], ['atransactions', 'Giao dịch'], ['aposts', 'Bài viết'], ['ameanings', 'Ý nghĩa phong thủy'], ['astaff', 'Nhân viên'], ['acustomers', 'Khách hàng'], ['avideos', 'Video'], ['anotifications', 'Thông báo'], ['aemailtpl', 'Mẫu email'], ['areviews', 'Đánh giá'], ['acollabs', 'Cộng tác viên'], ['acollabcontent', 'Nội dung CTV'], ['ainterestleads', 'Khách quan tâm'], ['achatbot', 'Trợ lý AI'], ['aauditlog', 'Nhật ký hệ thống'], ['arisklog', 'Rủi ro CTV'], ['amaintenance', 'Bảo trì hệ thống']];
