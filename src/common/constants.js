...
export const ADMIN_NAV = [['dash', 'Tổng quan'], ['aplates', 'Biển số'], ['acats', 'Danh mục'], ['acontacts', 'Yêu cầu liên hệ'], ['aposts', 'Bài viết'], ['ameanings', 'Ý nghĩa phong thủy'], ['astaff', 'Nhân viên'], ['acustomers', 'Khách hàng'], ['avideos', 'Video'], ['anotifications', 'Thông báo'], ['aemailtpl', 'Mẫu email'], ['areviews', 'Đánh giá'], ['acollabs', 'Cộng tác viên']];
