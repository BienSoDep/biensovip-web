...
import { Heart, X, Pencil, Trash2, Check, PlusCircle, CheckCircle2, ChevronDown, GitCompareArrows,
...
const ICONS = { heart: Heart, x: X, pencil: Pencil, 'trash-2': Trash2, check: Check, 'plus-circle': PlusCircle, 'check-circle': CheckCircle2, scale: GitCompareArrows,
