export const SCREENS = ['home', 'list', 'detail', 'register', 'login', 'forgot', 'adminForgot', 'adminReset', 'fav', 'profile', 'about', 'blog', 'post', 'lucky', 'chat', 'compare', 'saved', 'reviews', 'notifications', 'collab', 'terms', 'privacy', 'transfer', 'faq', 'gmailCallback', 'provinceLanding', 'plateTypeLanding', 'dash', 'aplates', 'acoupons', 'acats', 'acontacts', 'atransactions', 'aposts', 'ablogcomments', 'astaff', 'acustomers', 'avideos', 'anotifications', 'aemailtpl', 'acollabs', 'acollabcontent', 'ainterestleads', 'areviews', 'ameanings', 'achatbot', 'compose', 'aauditlog', 'arisklog', 'amaintenance', 'ashowroom', 'aerrorlogs', 'afeatureflags', 'adbconsole', 'apolicypages', 'actvtemplates'];
...
export const ADMIN_SCREENS = ['dash', 'aplates', 'acoupons', 'acats', 'acontacts', 'atransactions', 'aposts', 'ablogcomments', 'astaff', 'acustomers', 'avideos', 'anotifications', 'aemailtpl', 'acollabs', 'acollabcontent', 'ainterestleads', 'areviews', 'ameanings', 'achatbot', 'compose', 'aauditlog', 'arisklog', 'aguide', 'amaintenance', 'ashowroom', 'aerrorlogs', 'afeatureflags', 'adbconsole', 'apolicypages', 'actvtemplates'];
