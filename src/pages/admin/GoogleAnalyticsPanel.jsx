...
// Danh sách 36 event GA4 đang thật sự bắn từ code — nguồn duy nhất là
// docs/features/analytics/01..05-*.md (biensodep-infrastructure). Cập nhật file này khi thêm/bớt event
// thật trong src/services/tracking/events.js, không để lệch giữa 2 nơi.
...
const GA4_REPORT_URL = `https://analytics.google.com/analytics/web/#/p${GA4_PROPERTY_ID}/reports/reportinghub`;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)', background: 'var(--white)', borderRadius: 'var(--radius-card)', padding: 'var(--gutter-card)', boxShadow: 'var(--shadow-inset-hairline)' }}>
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 'var(--space-3)' }}>
        ...
        <span style={{ font: 'var(--type-caption)', color: 'var(--text-faint)' }}>{totalEvents} event đang track — traffic, hành vi khách theo thời gian thực</span>
        <div style={{ flex: 1 }} />
