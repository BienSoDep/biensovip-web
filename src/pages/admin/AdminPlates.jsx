...
import { CarFront, ArrowUpDown, ArrowUp, ArrowDown, TriangleAlert, Copy, Star, Gift, SlidersHorizontal, LayoutGrid, List as ListIcon, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function AdminPlates({ go, notify, st }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)', animation: 'pageIn 180ms var(--ease-out)' }}>
      ...
      {/* Mobile Card View (shown by default on <768px unless user switches to table) */}
      <div className={`admin-plates-cards-container ${mobileView === 'card' ? 'is-active' : ''}`}>
        ...
        {!isLoading && sortedPlates.map((p) => {
          ...
          return (
            ...
            >
              {/* Card top row: Checkbox + Plate Visual + Number + Hot + Issues + Price */}
              ...
              {/* Bottom Row: Quick Status selector & Actions */}
      ...
      {/* Table — desktop default or user switched */}
      ...
      {selected.size > 0 && (
        <div style={{ position: 'fixed', left: '50%', bottom: 24, transform: 'translateX(-50%)', zIndex: 'var(--z-bulk)', display: 'flex', alignItems: 'center', gap: 'var(--space-3)', padding: 'var(--space-2) var(--space-4)', background: 'var(--text-strong)', color: 'var(--white)', borderRadius: 'var(--radius-pill)', boxShadow: 'var(--shadow-4)', maxWidth: 'calc(100vw - 24px)', boxSizing: 'border-box' }}>
